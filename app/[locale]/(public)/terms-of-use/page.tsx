    ...
    <main>
      <article className='mx-auto max-w-[570px] lg:max-w-[800px]'>
        ...
        <p className='mx-6 mt-2'>
          The rf-z.com website located at rf-z.com is a copyrighted work
          belonging to rf-z.com. Certain features of the Site may be subject to
        ...
        <p className='mx-6 mt-2'>
          ...
          noncommercial use. The rights approved to you in these Terms are
