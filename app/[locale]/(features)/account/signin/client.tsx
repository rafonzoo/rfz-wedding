...
const SigninPageClient = () => {
  ...
  return (
    <main>
      <div className='absolute left-0 top-12 flex h-[calc(100%_-_48px)] min-h-[520px] w-full min-w-[320px] mn:min-h-[720px] mn:items-center mn:bg-zinc-100 [.dark_&]:bg-black'>
        <div className='mx-auto flex w-full flex-col items-center border-zinc-300 mn:-mt-[120px] mn:max-w-[372px] mn:rounded-lg mn:border mn:bg-white [.dark_&]:border-zinc-700 [.dark_&]:bg-black [.dark_&]:mn:bg-zinc-900'>
          <div className='w-full space-y-3 px-4 pt-20 text-center mn:pt-16'>
          ...
          {/* @TODO */}
          <ul className='absolute bottom-0 flex w-full justify-center pb-6 pt-4 text-center text-xs leading-[15px] tracking-base text-blue-600 opacity-50 mn:relative mn:mt-20 [.dark_&]:text-blue-400'>
            <li>Terms of Use</li>
